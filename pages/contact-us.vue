        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
          <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
            ...
            <p class="text-normal text-lg sm:text-2xl font-medium text-gray-600 dark:text-gray-400 mt-2">
              Fill in the form to leave your request
            </p>
          ...
          <form class="p-6 flex flex-col justify-center">
            ...
            <div class="flex flex-col mt-2">
              <label for="tel" class="hidden">Number</label>
              <textarea type="tel" placeholder="Type your message here" class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none">
              </textarea>
            </div>

            <button type="submit" class="md:w-32 bg-primary-600 hover:bg-primary-900 text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-indigo-500 transition ease-in-out duration-300">
              Submit
            </button>
          </form>
        </div>
